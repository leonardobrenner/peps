...
//====================================================================================//
//  Ask the Time for Transient Solution                                               //
//====================================================================================//
int Ask_Time_Transient_Solution()
{
 ...
 cout << "Enter time for transient solution: ";
 cin >> _time;
 if (_time == 0) {
...
//====================================================================================//
//  Ask a Transient Initial Vector Type                                               //
//====================================================================================//
v_tran Ask_a_Transient_Initial_Vector_Type()
{
 ...
 cout << "Enter a choice of transient initial vector: 1 equiprobable\n"
      << "                                            2 defined by one global state\n"
	  << "                                            3 defined by one local state\n"
      << "                                            4 user vector\n";
 cin >> choice;
 switch (choice) {
   case 1 : answer = equi_vec; break;
   case 2 : answer = global_vec; break;
   case 3 : answer = local_vec; break;
   case 4 : answer = user_vec; VCT::vct.erase(); break;
   default : cout << "\nAdopting option 1 (equiprobable)\n";
             answer = equi_vec;
 }
 return(answer);
                      ...
                      const rp resid)
{
 ...
 switch (s) {
   ...
   case Uniformization : out_file << "uniformization";  break;
 }
 ...
 if (resid < PRF::prf.min_err())
   out_file << ".vct is the stationary solution of the model " << descriptor_name
            << ".san)";
 else
   out_file << ".vct is NOT be the stationary solution of the model " << descriptor_name
          << ".san)\n===============================================================\n";
...
void Log_Out_a_Solution_Function(const func_id f, const rp v)
{
 ...
 out_file.precision(peps_precision);
 out_file << "\n" << f_name << ": " << v;
 if ((f+1) == DCT::dct.sfs())
   out_file << "\n===============================================================\n";
...
void Show_Credits()
{
 cout << "\n\n     PEPS - Performance Evaluation of Parallel Systems - version 2003"
      ...
      << "\n\n     The current version (2003) is an experimental version. Mathematical"
...
{cout << "\n\n     +--------------------------------------------------------+"
 ...
 case '1': cout << "\n\n             ******* Compiling a SAN Model *******"
           ...
           cin >> option;
           switch (option) {
           case '1': answer = comp_norm;      break;
           case '2': answer = comp_aggr_norm; break;
           case '3': answer = comp_lump_norm; } break;
 case '2': cout << "\n\n       ******* Solving a SAN model *******"
                << "\n\nStationary solutions:       Transient solutions:"
                << "\n\n 1) Power Method             4) Uniformization Method"
                <<   "\n 2) Arnoldi Method "
                <<   "\n 3) GMRES Method \n";
           cin >> option;
           switch (option) {
           ...
           case '4': answer = unifor_std;  } break;
 ...
 case 'c': cout << "\n\n         ******* Compiling partially a SAN Model *******"
                ...
                <<   "\n 5) Normalize                          you shouldn't be here!!"
                <<   "\n    (agg -> cnd)\n";
           cin >> option;
           switch (option) {
