...
private: peps_name    file_name;      // the file name of this structure
         ...
         peps_expr    reach_func;     // the expression of the reachability function
         peps_expr  * gf_exp;         // the expressions of the general functions
         peps_expr  * sf_exp;         // the expressions of the integration functions
