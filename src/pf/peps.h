...
//#include <pair>                 // a vector of pairs
#include <algorithm>                 // algorithms to manipulate maps
...
#define __RELEASE_DATE__   "Nov 11 2004"
...
const int max_peps_expr = 4096;         // Maximum size for expressions
