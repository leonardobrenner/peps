...
#ifdef _PEPS_DEBUG_
  if ((a < 0) && (a >= s.size()))
    Programming_Error ("wrong automaton index", 5304)
//  if (((i < 0) && ( i >= s.size(a))) || ((j < 0) && (j >= s.size(a))))
//    Programming_Error ("wrong coordinates", 5305)
  if (s.size() != FTB::ftb.aut())
    Programming_Error ("wrong size vector", 5306)
#endif
...
#ifdef _PEPS_DEBUG_
  if ((a < 0) && (a >= s.size()))
    Programming_Error ("wrong automaton index", 5307)
//  if ((e < 0) && (e >= events()))
//    Programming_Error ("wrong event index", 5308)
//  if (((i < 0) && ( i >= s.size(a))) || ((j < 0) && (j >= s.size(a))))
//    Programming_Error ("wrong coordinates", 5309)
  if (s.size() != FTB::ftb.aut())
    Programming_Error ("wrong size vector", 5310)
#endif
...
#ifdef _PEPS_DEBUG_
//  if ((a < 0) && (a >= s.size()))
//    Programming_Error ("wrong automaton index", 5311)
//  if ((e < 0) && (e >= events()))
//    Programming_Error ("wrong event index", 5312)
//  if (((i < 0) && ( i >= s.size(a))) || ((j < 0) && (j >= s.size(a))))
//    Programming_Error ("wrong coordinates", 5313)
  if (s.size() != FTB::ftb.aut())
    Programming_Error ("wrong size vector", 5314)
#endif
...
void DSC::reduce_a_group(const aut_id g)
{
 ...
 int     i, ai;       // counter for the states of the automata
